...
1. Наличие включеных в конфиге dnscrypt-proxy cloaking_rules и blocked_names_file. Достаточно закоментировать их на время проверки. Или использовать `-c` для указания конфига специально для тестирования.
2. Наличие включеной службы dnscrypt-proxy. Решается остановкой служб как в Windows, так и Linux. Так же, стоит проверить на наличие в фоновых процессах.
